...
function renderLogin(message = "") {
  ...
  document.querySelectorAll(".backChoices").forEach(b=>b.addEventListener("click",()=>{ document.getElementById("passwordInput").value=""; forms.forEach(f=>f.hidden=true); choices.hidden=false; heading.textContent="Get Started"; intro.hidden=false; }));
