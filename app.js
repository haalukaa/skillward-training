Warning: truncated output (original token count: 55664)
...
function pathwayAuthoringHtml(cont…5664 tokens truncated…ments")==="on",evidenceRequired:values.get("evidence")==="on"});authenticatedContext=await authService.restore(state.activeOrganizationId);renderAuthenticatedWorkspace();}));
