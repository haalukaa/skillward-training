(function (root) {
  ...
  function createStore(seed) {
    ...
    return { data, actorCanAccess, activeAdmins, protectFinalAdmin, trainerCapacity, setAccountStatus, assignTrainer, transfer, assignPathway, refreshReassessments, bulk, invite, ACCOUNT_STATUSES, EMPLOYMENT_STATUSES };
  }
