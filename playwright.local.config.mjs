...
export default defineConfig({
  testDir: "./tests/e2e",
  testMatch: ["phase1-local.spec.mjs", "phase6-reporting.spec.mjs", "phase7-security-operations.spec.mjs", "phase8-pwa.spec.mjs", "phase9-launch.spec.mjs", "advanced-owner-control-plane.spec.mjs"],
  fullyParallel: false,
  workers: 1,
  retries: 0,
  timeout: 75_000,
