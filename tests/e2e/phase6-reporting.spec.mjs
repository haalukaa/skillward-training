...
test("Phase 6 management reports load, contain at viewport and export real files", async ({ page }, testInfo) => {
  ...
  await page.evaluate(() => {
    ...
    authenticatedContext={user:{id:"10000000-0000-0000-0000-000000000001"},profile:{full_name:"Fictional Release QA"},platformAdministrator:null,membership:{organization_id:org,role:"Organisation Administrator"},memberships:[{organization_id:org,role:"Organisation Administrator",organizations:{name:"SkillWard Release QA"}}],organization:{id:org,name:"SkillWard Release QA",branding_settings:{}},facilities:[{id:"f0000000-0000-0000-0000-000000000001",name:"SkillWard QA Facility"}],departmentDetails:[{id:"d0000000-0000-0000-0000-000000000001",name:"Training Ward"}],learningPathways:[{id:"20000000-0000-0000-0000-000000000001",title:"Phase 2 QA Pathway"}],organizationStaff:[{user_id:worker,user_profiles:{full_name:"Fictional QA Worker"}}],organizationMemberships:[{user_id:worker,role:"PCA"}],reportExportEvents:[]};
