...
test("Phase 7 security operations load and create an audited incident at desktop and exact mobile width",async({page},testInfo)=>{
  ...
  await page.evaluate(()=>{
    ...
    authenticatedContext={user:{id:admin},profile:{full_name:"Fictional Release QA"},membership:{organization_id:org,role:"Organisation Administrator"},memberships:[{organization_id:org,role:"Organisation Administrator",organizations:{name:"SkillWard Release QA"}}],organization:{id:org,name:"SkillWard Release QA",branding_settings:{}},departmentDetails:[],organizationMemberships:[{user_id:admin,role:"Organisation Administrator"},{user_id:worker,role:"PCA"}]};
